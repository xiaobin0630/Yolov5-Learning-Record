...
class YoloBody(nn.Module):
    def __init__(self,anchors_mask,num_classes,phi,backbone='cspdarknet',pretrained=False,input_shape=[640,640]):
        ...
        dem_mul ,wid_mul = depth_dict[phi],width_dict[phi]

        base_channels = int(wid_mul * 64)
        base_depth = max(round(dem_mul * 3),1)
    ...
    def forward(self,x):
        ...
        P3 = torch.cat([P4_upsample,feature1],1)
        # (80,80,512) -> (80,80,256)
